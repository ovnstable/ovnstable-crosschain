...
async function main() {
    const ETHEREUM_SEPOLIA_RPC_URL = "https://1rpc.io/sepolia";
    const ARBITRUM_SEPOLIA_RPC_URL = "https://public.stackup.sh/api/v1/node/arbitrum-sepolia";
