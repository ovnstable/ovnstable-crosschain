...
contract InsuranceExchange is IInsuranceExchange, Initializable, AccessControlUpgradeable, UUPSUpgradeable, PausableUpgradeable {
    ...
    /**
     * @dev This function is calling when USDx (or other plus) make payout and there are extra value.
    ...
    /**
     * @dev This function is calling when USDx (or other plus) make payout and there are some loss value.
